...
public class Camera {
    ...
    private static final float TEMP_TILE_WIDTH = 1.0f;
    private static final float TEMP_TILE_RATIO = 1.0f;
    public static final Matrix4f viewToWorld = new Matrix4f()
        .rotate(-45.0f * (float) Math.PI / 180.0f, 0, 0, 1)
        .scale(TEMP_TILE_WIDTH, 1.0f / TEMP_TILE_RATIO * TEMP_TILE_WIDTH, 1);
